...
export const waterparkReviews = pgTable('waterpark_reviews', {
  ...
  ratingKidsFriendly: integer('rating_kids_friendly'),
  ratingWaitTime: integer('rating_wait_time'),
  ...
  ratingLifeguard: integer('rating_lifeguard'),
  ratingStaff: integer('rating_staff'),
